...
$model = new SolicitudesEmpresaModel();
...
<h1 class="h4 mb-3">Rechazar solicitud empresa</h1>

<?php if (!$sol): ?>
  <div class="alert alert-danger">Solicitud no encontrada.</div>
  <a class="btn btn-outline-secondary" href="empresas.php">Volver</a>
<?php else: ?>
  <div class="card shadow-sm p-3">
    <div class="mb-2"><strong><?php echo htmlspecialchars($sol['Nombre'] ?? ''); ?></strong> — <?php echo htmlspecialchars($sol['Mail'] ?? ''); ?></div>
    ...
    <form method="POST">
      ...
      <div class="d-flex gap-2 mt-3">
        ...
        <a class="btn btn-outline-secondary" href="empresas.php">Cancelar</a>
      </div>
    </form>
  </div>
